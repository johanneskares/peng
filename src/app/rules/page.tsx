    ...
    <main className="flex-grow container mx-auto">
      <article className="prose mx-auto prose-stone prose-invert">
        ...
        <ol>
          ...
          <li>
            Wait for the game master to send you a link to enter your email
            addresses.
          </li>
          <li>
            When everyone has entered their name & e-mail the Game Master can
            start the game.
          </li>
          <li>
            Everyone will receive an email with the name of the first target.
          </li>
          <li>
        ...
        <p>
          At the start of the round, the Game Master starts the game on the
          platform and each player receives a secret target via email. Keep it
          confidential—no spoilers—this is an assassination, not a gossip
          session. Optional: Write their name on a small piece of paper, fold
        ...
        <ul>
          <li>
            To take down your target, you must be completely alone with them in
            a fully enclosed space (a room, bathroom, car, tent, etc.).
          </li>
          <li>
            All doors and windows must be closed and no other people may be
            present in the space (Note: a bathroom stall with small gaps at the
            top or bottom qualifies as enclosed if the door and window are
            closed.)
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            ...
            your group of friends (optional but highly encouraged).
          </li>
        </ul>
        ...
        <p>
          The last surviving player wins eternal glory—or at least some bragging
          rights. Additional awards can add to the fun:
        </p>
        <ul>
          <li>
          ...
          <li>
            Serial Killer: For the player with the most eliminations - truly
            bloodthirsty and a true slaughterer.
          </li>
          <li>
            Secret Agent: The stealthiest player who got at least one super
            sneaky kill - a true James Bond.
          </li>
          <li>
            Banana Death: For the most ridiculous or embarrassing elimination
            (the victim may get blessed by the Cult of the Banana one day).
          </li>
        </ul>
        ...
        <p>
          Now that you know the rules... Sharpen your pistols, lock the door of
          your bathroom, trust no one, and let the Peng games begin! May the
          sneakiest, smartest, and cold blooded pengor claim the crown.
        </p>
      </article>
    </main>
  );
